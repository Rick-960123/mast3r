...
if __name__ == '__main__':
    ...
    images = load_images(['/home/rick/LightGlue/assets/sacre_coeur1.jpg', '/home/rick/LightGlue/assets/sacre_coeur2.jpg'], size=512)
    ...
    for i in range(n_viz):
        ...
        x0, y0, x1, y1 = map(int, [x0, y0, x1 + W0, y1])
        # Generate color based on match index
        color = tuple(map(int, cv2.applyColorMap(np.array([[i * 255 // (n_viz - 1)]], dtype=np.uint8), cv2.COLORMAP_JET)[0, 0]))
